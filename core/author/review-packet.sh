#!/bin/sh
# core/author/review-packet.sh — math-coding v0.993 peer-review.
#
# Usage:
...
# in packet.yaml:reviews[]. v0.993: applied packets require at
...
Records a peer-review entry. v0.993 requires at least one
...
# v0.993+: enforce self_approve_allowed
