(* core/render.ml -- site generation for math-coding v2.1.
...
<a href="%s">math-coding v2.1</a> &middot; Living Beings License &middot;
...
<p class="meta">%s &middot; v2.1 &middot; Y-fixed point</p>
</section>
...
<li><code>math/&lt;name&gt;/packet.md</code> &mdash; convention packets</li>
    ...
    in
  let index_page = render_page ~nav_key:"home" ~title:"math-coding v2.1"
    ~body:index_body in
