...
## Seven axioms (compact)
  ...
  A4. Process          process precedes code (draft → applied → retired)
  A5. Accounting       knowledge marked: fact | hypothesis | judgment | unknown | proven
  A6. Self-Application  the convention applies to itself
