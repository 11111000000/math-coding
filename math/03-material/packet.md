---
proposition: "The convention lives in plain text, in git, and runs on a POSIX shell. No other substrate is required. Three pillars: "
antithesis: "A convention that depends on a language, framework, IDE, or vendor outlives its usefulness only as long as that substrate survives. "
synthesis: "A3 fixes the material basis of math-coding:   packet.yaml      — plain text   decision.md      — plain text "
axiom: A3
substrate: none
---
