---
proposition: "Knowledge must be marked. Verdicts must be named. Changes must be witnessed. Modes must be honest about scope. Four instruments: "
antithesis: "Without epistemic markers, every claim is "fact" and nothing is checked. Without verdict outcomes, the verifier says "looks fine" "
synthesis: "axiom Accounting fixes four instruments of accounting. axiom Self-Application verifies that they are applied to the convention's own packets. "
axiom: A5
substrate: none
---
