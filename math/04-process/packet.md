---
proposition: "Process precedes code. The packet is written before the implementation. The lifecycle of a packet is finite and ordered. "
antithesis: "A process that begins with code cannot record intent. The implementation exists; the proposition does not. Six months later, a reviewer asks "why was this written this way?" and receives no answer, because the proposition was never asked. "
synthesis: "axiom Process fixes the temporal discipline of math-coding. The lifecycle FSM is "
axiom: A4
substrate: none
---
