---
proposition: "A developer shipping a 3 AM fix to a production outage cares whether the fix works the first time. A convention that does not record that fix loses the fix at the next handoff. "
antithesis: "Without care, a convention is ceremony. Agents and humans adopt it superficially, and drift grows in silence. The verifier passes; the code does nothing useful. The five files are filled with placeholder text. The SHA witness "
synthesis: "A1 names the motivation behind axiom Difference. Difference creates the gap. Care is what makes closing the gap worthwhile. Without A1, axiom Difference would describe a phenomenon without giving anyone a reason to do anything "
axiom: A1
substrate: none
---
